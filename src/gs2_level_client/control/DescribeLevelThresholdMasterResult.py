...
class DescribeLevelThresholdMasterResult(object):
    ...
    def get_items(self):
        ...
        レベルアップ経験値閾値を取得
        :return: レベルアップ経験値閾値
        :rtype: list[LevelThresholdMaster]
        """
        return self.__items
    ...
    def __getitem__(self, key):
        ...
        if key in items.keys():
            return items[key]
        return super(DescribeLevelThresholdMasterResult, self).__getitem__(key)
