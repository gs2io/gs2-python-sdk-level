...
class IncreaseExperienceByStampSheetRequest(Gs2UserRequest):

    class Constant(Gs2Level):
        FUNCTION = "IncreaseExperienceByStampSheet"
    ...
    def __init__(self, params=None):
        ...
        """
        super(IncreaseExperienceByStampSheetRequest, self).__init__(params)
        if params is None:
            self.__sheet = None
    ...
    def with_sheet(self, sheet):
        ...
        :type sheet: unicode
        :return: this
        :rtype: IncreaseExperienceByStampSheetRequest
        """
