...
class DescribeResourcePoolRequest(Gs2BasicRequest):

    class Constant(Gs2Level):
        FUNCTION = "DescribeResourcePool"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DescribeResourcePoolRequest, self).__init__(params)
        if params is None:
    ...
    def with_page_token(self, page_token):
        ...
        :type page_token: unicode
        :return: this
        :rtype: DescribeResourcePoolRequest
        """
