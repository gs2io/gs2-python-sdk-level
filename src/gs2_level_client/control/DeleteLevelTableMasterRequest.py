...
class DeleteLevelTableMasterRequest(Gs2BasicRequest):

    class Constant(Gs2Level):
        FUNCTION = "DeleteLevelTableMaster"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DeleteLevelTableMasterRequest, self).__init__(params)
        if params is None:
    ...
    def with_resource_pool_name(self, resource_pool_name):
        ...
        :type resource_pool_name: unicode
        :return: this
        :rtype: DeleteLevelTableMasterRequest
        """
