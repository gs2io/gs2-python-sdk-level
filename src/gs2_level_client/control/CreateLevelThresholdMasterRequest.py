...
class CreateLevelThresholdMasterRequest(Gs2BasicRequest):

    class Constant(Gs2Level):
        FUNCTION = "CreateLevelThresholdMaster"
    ...
    def __init__(self, params=None):
        ...
        """
        super(CreateLevelThresholdMasterRequest, self).__init__(params)
        if params is None:
    ...
    def with_resource_pool_name(self, resource_pool_name):
        ...
        :type resource_pool_name: unicode
        :return: this
        :rtype: CreateLevelThresholdMasterRequest
        """
