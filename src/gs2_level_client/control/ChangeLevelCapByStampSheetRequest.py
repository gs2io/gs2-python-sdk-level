...
class ChangeLevelCapByStampSheetRequest(Gs2UserRequest):

    class Constant(Gs2Level):
        FUNCTION = "ChangeLevelCapByStampSheet"
    ...
    def __init__(self, params=None):
        ...
        """
        super(ChangeLevelCapByStampSheetRequest, self).__init__(params)
        if params is None:
            self.__sheet = None
    ...
    def with_sheet(self, sheet):
        ...
        :type sheet: unicode
        :return: this
        :rtype: ChangeLevelCapByStampSheetRequest
        """
